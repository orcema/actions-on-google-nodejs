...
/** @public */
export declare type ConfirmationArgument = boolean;
/**
 ...
 * @public
 */
export declare class Confirmation extends SoloQuestion<'actions.intent.CONFIRMATION', Api.GoogleActionsV2ConfirmationValueSpec> {
    /**
