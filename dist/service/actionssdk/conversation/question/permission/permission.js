 ...
 * @public
 */
class Permission extends question_1.SoloQuestion {
    /**
    ...
    constructor(options) {
        ...
        this._data('type.googleapis.com/google.actions.v2.PermissionValueSpec', Object.assign({ optContext: options.context, permissions: common_1.toArray(options.permissions) }, options.extra));
    }
}
