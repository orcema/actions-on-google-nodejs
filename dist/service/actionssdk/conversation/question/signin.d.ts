...
/** @public */
export declare type SignInArgument = Api.GoogleActionsV2SignInValue;
/**
 ...
 * @public
 */
export declare class SignIn extends SoloQuestion<'actions.intent.SIGN_IN', Api.GoogleActionsV2SignInValueSpec> {
    /**
