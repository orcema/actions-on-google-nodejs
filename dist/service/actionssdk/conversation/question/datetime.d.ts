...
/** @public */
export declare type DateTimeArgument = Api.GoogleActionsV2DateTime;
 ...
 * @public
 */
export declare class DateTime extends SoloQuestion<'actions.intent.DATETIME', Api.GoogleActionsV2DateTimeValueSpec> {
    /**
